...
@NoArgsConstructor
@AllArgsConstructor
public class ViewingHistoryForPd {
    BigDecimal totalVideoSales;

    BigDecimal totalVideoProfitTree;

    BigDecimal totalVideoViews;

    BigDecimal totalVideoCount;

    Page<VideoSalesHistoryForAdminDashboard> videoSalesHistoryForAdminDashboardList;
}
