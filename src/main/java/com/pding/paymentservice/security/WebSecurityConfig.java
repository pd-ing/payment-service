        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers(HttpMethod.OPTIONS).permitAll()
                                ...
                                .requestMatchers("/api/payment/admin/listReferredPdsEOL").permitAll()
                                .requestMatchers("/api/payment/admin/listReferrerPds").permitAll()
                                .requestMatchers("/api/payment/admin/listReferredPds").permitAll()
                                ...
                                .requestMatchers("/api/payment/admin/withdrawalHistoryTabForPd").permitAll()
                                ...
                                .requestMatchers("/api/payment/admin/referenceTabDetails").permitAll()
                                ...
                                .requestMatchers("/api/payment/videoPurchaseTimeRemaining").authenticated()
                );
