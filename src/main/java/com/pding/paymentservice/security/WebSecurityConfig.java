        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers(HttpMethod.OPTIONS).permitAll()
                                ...
                                .requestMatchers("/api/payment/admin/purchased-ticket-history").authenticated()
                                ...
                                .requestMatchers("/api/payment/topDonorsListDownload").authenticated()
                                .requestMatchers("/api/payment/topDonorsListDownloadPreparing").authenticated()
                                ...
                                .requestMatchers("/api/payment/getAllPdWhoseVideosAreExpiredByUser").authenticated()
                                ...
                                .requestMatchers("/api/payment/salesHistoryDownload").authenticated()
                                .requestMatchers("/api/payment/salesHistoryDownloadPreparing").authenticated()
                                ...
                                .requestMatchers("/api/payments/packages/**").authenticated()
                );
